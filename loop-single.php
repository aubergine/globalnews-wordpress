<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
      ...
      <div class="post" id="post-<?php the_ID(); ?>">
        ...
        <p class="postmetadata"><span>Posted by <?php the_author_posts_link(); ?></span>Posted on <?php the_time('l, F jS, Y') ?></p>
        <div class="post_image">
          ...
          <ul id="post-links" class="clearingfix">
            ...
            <li class="comments"><a href="#respond">Add Comments</a></li>
            <li class="print"><a href="javascript:window.print()">Print</a></li>
            <script type="text/javascript">var addthis_pub="49f3b26b0ed18b53";</script>
            <li class="favorite"><a href="http://www.addthis.com/bookmark.php?v=20" onmouseover="return addthis_open(this, '', '[URL]', '[TITLE]')" onmouseout="addthis_close()" onclick="return addthis_sendto()">Add to Favorites</a></li>
